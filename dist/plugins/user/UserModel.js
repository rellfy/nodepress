...
var Model = /** @class */ (function () {
    ...
    Object.defineProperty(Model, "JoiSchema", {
        get: function () {
            return joi_1.default.object().keys({
                ...
                username: joi_1.default.string().min(3).max(16).alphanum(),
                role: joi_1.default.string().max(16).alphanum(),
                email: joi_1.default.object().keys({
                    address: joi_1.default.string().email()
                }),
                credentials: joi_1.default.object().keys({
                    salt: joi_1.default.string().min(3),
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, Model.RegisterVerification(this)];
                        case 1:
                            _b.sent();
                            return [2 /*return*/];
                    }
    ...
    Model.RegisterVerification = function (model) {
        return __awaiter(this, void 0, void 0, function () {
            var query, users;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        users = _a.sent();
                        if (users.length > 0)
                            throw boom_1.default.badRequest('An user with the same username or email is already registered');
                        return [2 /*return*/];
                }
            });
        });
...
var UserModel = mongoose_1.default.model(Model.Name, Model.Schema);
